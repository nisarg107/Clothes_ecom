...
import 'package:mysqlpractise/users/controllers/itemcontroller.dart';
 ...
 addItemToCart() async{
  try {
    var res=await http.post(Uri.parse(API.addTocart),body: {
      ...
      "color": widget.itemInfo!.sizes![itemDetailsController.color],
     ...
     if (res.statusCode ==
      ...
      {
        try {
          final resBodyOfLogin =
              await jsonDecode(res.body) as Map<String, dynamic>;
          final success = resBodyOfLogin['success'] as bool;
          if (success == true) {
            Fluttertoast.showToast(msg: "Item saved to cart successfully");
          } else {
            print(res.body);
            Fluttertoast.showToast(msg: "Error item not saved to cart");
          }
      ...
      body: Stack(
        children: [
          ...
          FadeInImage(
            ...
            fit: BoxFit.cover,
            placeholder: const NetworkImage("https://miro.medium.com/v2/resize:fit:679/1*ngNzwrRBDElDnf2CLF_Rbg.gif"),
            image: NetworkImage(
